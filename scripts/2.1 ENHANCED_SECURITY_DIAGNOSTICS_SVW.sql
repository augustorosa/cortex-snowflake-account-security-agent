...
FACTS (
  ...
  QUERY_ATTRIBUTION_HISTORY.WAREHOUSE_ID AS WAREHOUSE_ID_ATTRIBUTION COMMENT='Unique identifier for the warehouse in attribution history.'
)
DIMENSIONS (
  ...
  QUERY_ATTRIBUTION_HISTORY.END_TIME AS ATTRIBUTION_END_TIME COMMENT='The date and time when the attribution event ended.',
  QUERY_ATTRIBUTION_HISTORY.PARENT_QUERY_ID AS PARENT_QUERY_ID COMMENT='Unique identifier of the parent query.',
  QUERY_ATTRIBUTION_HISTORY.QUERY_HASH AS ATTRIBUTION_QUERY_HASH COMMENT='Unique identifier for a query in attribution history.',
  QUERY_ATTRIBUTION_HISTORY.QUERY_ID AS ATTRIBUTION_QUERY_ID COMMENT='Unique identifier for a query in attribution history.',
  QUERY_ATTRIBUTION_HISTORY.QUERY_PARAMETERIZED_HASH AS ATTRIBUTION_QUERY_PARAMETERIZED_HASH COMMENT='A unique identifier for a parameterized query in attribution history.',
  QUERY_ATTRIBUTION_HISTORY.QUERY_TAG AS ATTRIBUTION_QUERY_TAG COMMENT='Metadata tags associated with a query in attribution history.',
  QUERY_ATTRIBUTION_HISTORY.ROOT_QUERY_ID AS ROOT_QUERY_ID COMMENT='Unique identifier for the root query.',
  QUERY_ATTRIBUTION_HISTORY.START_TIME AS ATTRIBUTION_START_TIME COMMENT='The timestamp when the attribution event started.',
  QUERY_ATTRIBUTION_HISTORY.USER_NAME AS ATTRIBUTION_USER_NAME COMMENT='The user in attribution history.',
  QUERY_ATTRIBUTION_HISTORY.WAREHOUSE_NAME AS ATTRIBUTION_WAREHOUSE_NAME COMMENT='The warehouse name in attribution history.'
)
